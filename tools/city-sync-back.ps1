...
$paths = @(
    ...
    "Assets\PSXRacing\Resources\charlotte_city.bytes.meta",
    "Assets\PSXRacing\Resources\charlotte_dem.bytes.meta",
    "Assets\PSXRacing\Resources\charlotte_bld.bytes.meta",
    "Assets\PSXRacing\Resources\charlotte_routes.json.meta",
    "Assets\PSXRacing\Art\City.meta",
    "Assets\PSXRacing\Scripts\City.meta",
    "Assets\PSXRacing\Scripts\City\CityMap.cs.meta",
    "Assets\PSXRacing\Scripts\City\RoadProfiles.cs.meta",
    ...
    "Assets\PSXRacing\Scripts\City\CityMinimap.cs.meta",
    "Assets\PSXRacing\Editor\CityPlayCheck.cs.meta",
    "Assets\PSXRacing\Editor\CityGroundProbe.cs.meta",
